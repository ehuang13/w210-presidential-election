...
class MODEL(object):
    ...
    def run(self):
        ...
        with tf.Session() as sess:
            ...
            cand_20_t_ste_x, cand_20_t_ste_target_word, cand_20_t_ste_y, cand_20_t_ste_tarmask,             cand_20_t_ste_loc, cand_20_t_ste_mode =                 read_data('{}news/immigration/fox-news/trump/'.format(self.data_path), self.word_id_mapping,                           self.max_sentence_len, self.max_target_len, 'ASC')
            
            cand_20_b_ste_x, cand_20_b_ste_target_word, cand_20_b_ste_y, cand_20_b_ste_tarmask,             cand_20_b_ste_loc, cand_20_b_ste_mode =                 read_data('{}news/immigration/fox-news/biden/'.format(self.data_path), self.word_id_mapping,                           self.max_sentence_len, self.max_target_len, 'ASC')
